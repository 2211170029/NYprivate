...
%------------------------------------------------------------------------------------------------------------
\subsection{検波回路}
図4.7に製作した検波回路,図4.8に検波回路の動作波形を示す.ファンクションジェネレータを出力端子に接続し,設定値を周波数13.56MHz,
...
本研究で製作した自動整合器を図4.9,図4.10,図4.11に示す.
...
また,電源電圧に対する入力電力,進行波電力,効率の入出力特性グラフを図4.12に示す.
...
先ほど同様に測定を行い,測定結果を表4.1,入出力特性グラフを図4.12に示す.
また,効率の比較を図4.13に示す.
